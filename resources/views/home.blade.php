        ...
        <div class="aside_left">
          <div class="aside_content">
            <div class="aside_title">
              <h1 id="noborder">Perché affittare su Apulian Sight?</h1>
            </div>
            <div class="aside_p">
              <p>Indipendentemente dal tipo di alloggio o stanza che vuoi condividere, Apulian Sight rende semplice e sicuro ospitare dei viaggiatori. Spetta a te il controllo completo della disponibilità, dei prezzi, delle regole della casa e della modalità di interazione con gli ospiti.</p>
            </div>
            <div class="aside_img">
