    ...
    <div class="apartment">
      ...
      <div class="section2">
        ...
        <div class="apartment-services">
          ...
          <h6 class="text-center">Distanza da luoghi principali:</h6>
          <ul class="list-group">
            @for ($i = 0; $i < count($points); $i++)
              <li class="pointOfInterest list-group-item">Da {{$interestPoint[$i]['name']}} = {{$points[$i]}} km</li>
            @endfor
          </ul>
    ...
    <script>
      ...
      function  getDistanceBetweenPoints(latitude1, longitude1, latitude2, longitude2, unit = 'kilometers') {
          ...
          if (unit == 'miles') {
            ...
            console.log(Math.round(distance * 1.609344));
          }
      }
