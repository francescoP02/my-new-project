...
<div class="main_content">
  <div class="sponsored_and_filters">
    ...
    <img class="logobnb-loading" src="{{asset('img/apulian-sight-logo')}}" alt="apulian-sight-logo">
    <div class="container">
      ...
      $('.filter').change(function (e) {
          ...
          $.ajax({
              ...
              success: function (response) {
                ...
                if (data.length > 0) {
                  @auth
                    let allApartments = @json($apartments);
                    let allApartmentsPreferences = response.preferences;
                    let userId = {{ auth() -> user() -> id }};
                    let icon;

                    let apartmentsWithPreferences = [];
                    let apartmentsWithPreferencesUserID = [];

                    for (let preference of allApartmentsPreferences) {
                      for (let apartmentNotFilter of allApartments) {
                    ...
                    for (let apartmentWithPref of apartmentsWithPreferences) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                      ...
                      let apartment = data[i];
                      let favorite = '';

                      for (let pref of apartmentsWithPreferencesUserID) {
